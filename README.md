...
$ mkdir -p $GOPATH/src/github.com/DharitriOne
$ cd $GOPATH/src/github.com/DharitriOne
$ git clone https://github.com/DharitriOne/drt-chain-go
$ cd drt-chain-go && git checkout master
...
```
$ cd $GOPATH/src/github.com/DharitriOne/drt-chain-go/cmd/keygenerator
$ go build
$ ./keygenerator
```
...
4. Fetch the repo github.com/DharitriOne/protobuf
