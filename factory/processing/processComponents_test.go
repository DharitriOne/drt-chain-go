...
import (
	...
	"github.com/DharitriOne/drt-chain-core-go/core/keyValStorage"
	...
	"github.com/DharitriOne/drt-chain-go/common/factory"
	disabledStatistics "github.com/DharitriOne/drt-chain-go/common/statistics/disabled"
	...
	processComp "github.com/DharitriOne/drt-chain-go/factory/processing"
	"github.com/DharitriOne/drt-chain-go/genesis"
	genesisMocks "github.com/DharitriOne/drt-chain-go/genesis/mock"
	testsMocks "github.com/DharitriOne/drt-chain-go/integrationTests/mock"
	...
	txExecOrderStub "github.com/DharitriOne/drt-chain-go/testscommon/common"
	"github.com/DharitriOne/drt-chain-go/testscommon/components"
	"github.com/DharitriOne/drt-chain-go/testscommon/cryptoMocks"
	"github.com/DharitriOne/drt-chain-go/testscommon/dataRetriever"
	...
	factoryMocks "github.com/DharitriOne/drt-chain-go/testscommon/factory"
	"github.com/DharitriOne/drt-chain-go/testscommon/genericMocks"
	nodesSetupMock "github.com/DharitriOne/drt-chain-go/testscommon/genesisMocks"
	...
	testState "github.com/DharitriOne/drt-chain-go/testscommon/state"
	"github.com/DharitriOne/drt-chain-go/testscommon/statusHandler"
	updateMocks "github.com/DharitriOne/drt-chain-go/update/mock"
	"github.com/stretchr/testify/require"
)

const (
	testingProtocolSustainabilityAddress = "moa1932eft30w753xyvme8d49qejgkjc09n5e49w4mwdjtm0neld797s3hts63"
)
	...
	args := processComp.ProcessComponentsFactoryArgs{
		...
		SystemSCConfig: &config.SystemSmartContractsConfig{
			...
			GovernanceSystemSCConfig: config.GovernanceSystemSCConfig{
				...
				OwnerAddress: "moa1vxy22x0fj4zv6hktmydg8vpfh6euv02cz4yg0aaws6rrad5a5awq9cstml",
			},
			...
			DelegationManagerSystemSCConfig: config.DelegationManagerSystemSCConfig{
				...
				MinStakeAmount:      "100",
				ConfigChangeAddress: "moa1vxy22x0fj4zv6hktmydg8vpfh6euv02cz4yg0aaws6rrad5a5awq9cstml",
			},
...
func TestProcessComponentsFactory_Create(t *testing.T) {
	...
	t.Run("should work with indexAndReturnGenesisAccounts failing due to Unmarshal failure", func(t *testing.T) {
		...
		stateCompMock.Accounts = &testState.AccountsStub{
			GetAllLeavesCalled: func(leavesChannels *common.TrieIteratorChannels, ctx context.Context, rootHash []byte, trieLeavesParser common.TrieLeafParser) error {
				addrOk, _ := addrPubKeyConv.Decode("moa17c4fs6mz2aa2hcvva2jfxdsrdknu4220496jmswer9njznt22edszmqsl9")
				addrNOK, _ := addrPubKeyConv.Decode("moa1ulhw20j7jvgfgak5p05kv667k5k9f320sgef5ayxkt9784ql0zssw6zcw3")
