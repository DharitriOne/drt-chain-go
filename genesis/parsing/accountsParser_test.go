...
import (
	...
	scrData "github.com/DharitriOne/drt-chain-core-go/data/smartContractResult"
	transactionData "github.com/DharitriOne/drt-chain-core-go/data/transaction"
...
func TestAccountsParser_createMintTransaction(t *testing.T) {
	pkConv, _ := pubkeyConverter.NewBech32PubkeyConverter(32, "moa")
	expectedAddr, _ := pkConv.Decode("moa17rc0pu8s7rc0pu8s7rc0pu8s7rc0pu8s7rc0pu8s7rc0pu8s7rcqdw3ycp")
	ap := parsing.NewTestAccountsParser(pkConv)
	balance := int64(1)
	ibs := []*data.InitialAccount{
		createSimpleInitialAccount("moa1spyavw0956vq68xj8y4tenjpq2wd5a9p2c6j8gsz7ztyrnpxrruq0yu4wk", balance),
	}
...
func TestAccountsParser_GenesisMintingAddress(t *testing.T) {
	...
	assert.Equal(t, "moa17rc0pu8s7rc0pu8s7rc0pu8s7rc0pu8s7rc0pu8s7rc0pu8s7rcqdw3ycp", addr)
}
