...
import (
	...
	commonFactory "github.com/DharitriOne/drt-chain-go/common/factory"
	...
	"github.com/DharitriOne/drt-chain-go/genesis/data"
		...
		AccountsParser: &mock.AccountsParserStub{
			InitialAccountsCalled: func() []genesis.InitialAccountHandler {
				...
				acc1 := data.InitialAccount{
					Address:      "moa1ulhw20j7jvgfgak5p05kv667k5k9f320sgef5ayxkt9784ql0zssw6zcw3",
				...
				acc2 := data.InitialAccount{
					Address:      "moa17c4fs6mz2aa2hcvva2jfxdsrdknu4220496jmswer9njznt22edszmqsl9",
					Supply:       big.NewInt(0).Mul(big.NewInt(2500000000), big.NewInt(1000000000000)),
					Balance:      balance,
					StakingValue: big.NewInt(0).Mul(big.NewInt(2500000000), big.NewInt(1000000000000)),
					Delegation: &data.DelegationData{
				...
				acc3 := data.InitialAccount{
					Address:      "moa10d2gufxesrp8g409tzxljlaefhs0rsgjle3l7nq38de59txxt8cslvnh3p",
					Supply:       big.NewInt(0).Mul(big.NewInt(2500000000), big.NewInt(1000000000000)),
					Balance:      balance,
					StakingValue: big.NewInt(0).Mul(big.NewInt(2500000000), big.NewInt(1000000000000)),
					Delegation: &data.DelegationData{
