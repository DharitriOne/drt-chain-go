...
type ValidatorInfo struct {
	...
	AccumulatedFees                 *math_big.Int `protobuf:"bytes,15,opt,name=AccumulatedFees,proto3,casttypewith=math/big.Int;github.com/DharitriOne/drt-chain-core-go/data.BigIntCaster" json:"accumulatedFees,omitempty"`
