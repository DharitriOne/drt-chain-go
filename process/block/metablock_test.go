...
func TestMetaProcessor_CrossChecksBlockHeightsMetrics(t *testing.T) {
	...
	requireInstance.Equal("0: 37, 1: 38, 2: 39, ", savedMetrics["moa_cross_check_block_height"])
	requireInstance.Equal(uint64(37), savedMetrics["moa_cross_check_block_height_0"])
	requireInstance.Equal(uint64(38), savedMetrics["moa_cross_check_block_height_1"])
	requireInstance.Equal(uint64(39), savedMetrics["moa_cross_check_block_height_2"])
}
