...
func TestPresenterStatusHandler_GetCpuLoadPercent(t *testing.T) {
	...
	presenterStatusHandler.SetUInt64Value(common.MetricCpuLoadPercent, cpuPercentLoad)
...
func TestPresenterStatusHandler_GetMemLoadPercent(t *testing.T) {
	...
	presenterStatusHandler := NewPresenterStatusHandler()
	presenterStatusHandler.SetUInt64Value(common.MetricMemLoadPercent, memPercentLoad)
...
func TestPresenterStatusHandler_GetTotalMem(t *testing.T) {
	...
	presenterStatusHandler := NewPresenterStatusHandler()
	presenterStatusHandler.SetUInt64Value(common.MetricMemTotal, totalMem)
...
func TestPresenterStatusHandler_GetMemUsedByNode(t *testing.T) {
	...
	presenterStatusHandler := NewPresenterStatusHandler()
	presenterStatusHandler.SetUInt64Value(common.MetricMemUsedGolang, memUsedByNode)
...
func TestPresenterStatusHandler_GetNetworkRecvPercent(t *testing.T) {
	...
	presenterStatusHandler := NewPresenterStatusHandler()
	presenterStatusHandler.SetUInt64Value(common.MetricNetworkRecvPercent, networkRecvPercent)
...
func TestPresenterStatusHandler_GetNetworkRecvBps(t *testing.T) {
	...
	presenterStatusHandler := NewPresenterStatusHandler()
	presenterStatusHandler.SetUInt64Value(common.MetricNetworkRecvBps, networkRecvBps)
...
func TestPresenterStatusHandler_GetNetworkRecvBpsPeak(t *testing.T) {
	...
	presenterStatusHandler := NewPresenterStatusHandler()
	presenterStatusHandler.SetUInt64Value(common.MetricNetworkRecvBpsPeak, networkRecvBpsPeak)
...
func TestPresenterStatusHandler_GetNetworkSentPercent(t *testing.T) {
	...
	presenterStatusHandler := NewPresenterStatusHandler()
	presenterStatusHandler.SetUInt64Value(common.MetricNetworkSentPercent, networkSentPercent)
...
func TestPresenterStatusHandler_GetNetworkSentBps(t *testing.T) {
	...
	presenterStatusHandler := NewPresenterStatusHandler()
	presenterStatusHandler.SetUInt64Value(common.MetricNetworkSentBps, networkSentBps)
...
func TestPresenterStatusHandler_GetNetworkSentBpsPeak(t *testing.T) {
	...
	presenterStatusHandler := NewPresenterStatusHandler()
	presenterStatusHandler.SetUInt64Value(common.MetricNetworkSentBpsPeak, networkSentBpsPeak)
...
func TestPresenterStatusHandler_GetNetworkSendBytesInEpoch(t *testing.T) {
	...
	presenterStatusHandler := NewPresenterStatusHandler()
	presenterStatusHandler.SetUInt64Value(common.MetricNetworkSendBytesInCurrentEpochPerHost, networkBytesSentInEpoch)
...
func TestPresenterStatusHandler_GetNetworkReceivedBytesInEpoch(t *testing.T) {
	...
	presenterStatusHandler := NewPresenterStatusHandler()
	presenterStatusHandler.SetUInt64Value(common.MetricNetworkRecvBytesInCurrentEpochPerHost, networkBytesSentInEpoch)
