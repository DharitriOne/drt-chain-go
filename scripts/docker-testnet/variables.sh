...
# Path to drt-chain-go. Determined automatically. Do not change.
...
# Path to drt-chain-deploy-go, branch: master. Default: near drt-chain-go.
...
# Path to drt-chain-proxy-go, branch: master. Default: near drt-chain-go.
...
# Path to drt-chain-txgen-go. Default: near drt-chain-go.
