...
git clone git@github.com:DharitriOne/drt-chain-deploy-go.git
git clone git@github.com:DharitriOne/drt-chain-proxy-go.git


if [[ $PRIVATE_REPOS -eq 1 ]]; then
  git clone git@github.com:DharitriOne/drt-chain-txgen-go.git
