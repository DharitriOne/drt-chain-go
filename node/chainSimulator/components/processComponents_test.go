...
import (
	...
	retriever "github.com/DharitriOne/drt-chain-go/dataRetriever"
	mockFactory "github.com/DharitriOne/drt-chain-go/factory/mock"
	"github.com/DharitriOne/drt-chain-go/integrationTests/mock"
	"github.com/DharitriOne/drt-chain-go/sharding"
	chainStorage "github.com/DharitriOne/drt-chain-go/storage"
...
const testingProtocolSustainabilityAddress = "moa1932eft30w753xyvme8d49qejgkjc09n5e49w4mwdjtm0neld797s3hts63"
	...
	args := ArgsProcessComponentsHolder{
		...
		EconomicsConfig: config.EconomicsConfig{
			GlobalSettings: config.GlobalSettings{
				...
				MinimumInflation:            0,
				GenesisMintingSenderAddress: "moa17rc0pu8s7rc0pu8s7rc0pu8s7rc0pu8s7rc0pu8s7rc0pu8s7rcqdw3ycp",
