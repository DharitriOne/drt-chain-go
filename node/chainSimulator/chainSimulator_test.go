...
func TestChainSimulator_SetState(t *testing.T) {
	...
	address := "moa1qtc600lryvytxuy4h7vn7xmsy5tw6vuw3tskr75cwnmv4mnyjgsqhpjd5z"
...
func TestChainSimulator_SetEntireState(t *testing.T) {
	...
	contractAddress := "moa1qqqqqqqqqqqqqpgqmzzm05jeav6d5qvna0q2pmcllelkz8xddz3sf2kd6y"
	accountState := &dtos.AddressState{
		...
		CodeMetadata:     "BQY=",
		Owner:            "moa1ss6u80ruas2phpmr82r42xnkd6rxy40g9jl69frppl4qez9w2jpsd2pfew",
...
func TestChainSimulator_GetAccount(t *testing.T) {
	...
	address := dtos.WalletAddress{
		Bech32: "moa1qtc600lryvytxuy4h7vn7xmsy5tw6vuw3tskr75cwnmv4mnyjgsqhpjd5z",
	}
...
func TestSimulator_SendTransactions(t *testing.T) {
	...
	initialMinting := big.NewInt(0).Mul(oneRewa, big.NewInt(100))
