...
import (
	...
	atomicCore "github.com/DharitriOne/drt-chain-core-go/core/atomic"
	...
	"github.com/DharitriOne/drt-chain-core-go/data/guardians"
	...
	"github.com/DharitriOne/drt-chain-go/dblookupext/dcdtSupply"
	"github.com/DharitriOne/drt-chain-go/factory"
	factoryMock "github.com/DharitriOne/drt-chain-go/factory/mock"
	heartbeatData "github.com/DharitriOne/drt-chain-go/heartbeat/data"
	integrationTestsMock "github.com/DharitriOne/drt-chain-go/integrationTests/mock"
	...
	nodeMockFactory "github.com/DharitriOne/drt-chain-go/node/mock/factory"
	...
	factoryTests "github.com/DharitriOne/drt-chain-go/testscommon/factory"
	...
	mockStorage "github.com/DharitriOne/drt-chain-go/testscommon/storage"
	...
	"github.com/DharitriOne/drt-chain-go/testscommon/txsSenderMock"
...
func TestNode_GetCodeHashAccNotFoundShouldReturnEmpty(t *testing.T) {
	...
	codeHash, bInfo, err := n.GetCodeHash("moa1qyu5wthldzr8wx5c9ucg8kjagg0jfs53s8nr3zpz3hypefsdd8ssfq94h8", api.AccountQueryOptions{})
	require.Nil(t, err)
	require.Equal(t, dummyBlockInfo.apiResult(), bInfo)
...
func TestValidateTransaction_ShouldAdaptAccountNotFoundError(t *testing.T) {
	...
	err := n.ValidateTransaction(tx)
	require.Equal(t, "insufficient funds for address moa1xycnzvf3xycnzvf3xycnzvf3xycnzvf3xycnzvf3xycnzvf3xycsvqxj32", err.Error())
}
...
func TestNode_IsDataTrieMigrated(t *testing.T) {
	...
	t.Run("load account err", func(t *testing.T) {
		...
		isMigrated, err := n.IsDataTrieMigrated("moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqplllsxxctf0", api.AccountQueryOptions{})
		assert.False(t, isMigrated)
		assert.Equal(t, expectedErr, err)
	})
