...
import (
	...
	processMocks "github.com/DharitriOne/drt-chain-go/process/mock"
	...
	"github.com/DharitriOne/drt-chain-go/testscommon/txcachemocks"
...
func TestPrepareUnsignedTx(t *testing.T) {
	...
	n.txUnmarshaller.addressPubKeyConverter, _ = pubkeyConverter.NewBech32PubkeyConverter(addrSize, "moa")
	n.addressPubKeyConverter, _ = pubkeyConverter.NewBech32PubkeyConverter(addrSize, "moa")
	...
	expectedScr1 := &transaction.ApiTransactionResult{
		...
		Value:          "2",
		Receiver:       "moa1qyqszqgpqyqszqgpqyqszqgpqyqszqgpqyqszqgpqyqszqgpqyqsjzlqaw",
		Sender:         "moa1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqhsx6tv",
		OriginalSender: "",
	...
	expectedScr2 := &transaction.ApiTransactionResult{
		...
		Type:           string(transaction.TxTypeUnsigned),
		Value:          "4",
		Receiver:       "moa1qcrqvpsxqcrqvpsxqcrqvpsxqcrqvpsxqcrqvpsxqcrqvpsxqcrqrw37ef",
		Sender:         "moa1q5zs2pg9q5zs2pg9q5zs2pg9q5zs2pg9q5zs2pg9q5zs2pg9q5zswckevp",
		OriginalSender: "moa1qurswpc8qurswpc8qurswpc8qurswpc8qurswpc8qurswpc8qursxugy0t",
		CallType:       vm.DirectCallStr,
	}
