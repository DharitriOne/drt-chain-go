//go:generate protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/DharitriOne/protobuf/protobuf  --gogoslick_out=. staking.proto
...
func (s *stakingSC) Execute(args *vmcommon.ContractCallInput) vmcommon.ReturnCode {
	...
	if len(args.DCDTTransfers) > 0 {
		s.eei.AddReturnMessage("cannot transfer DCDT to system SCs")
		return vmcommon.UserError
	}
