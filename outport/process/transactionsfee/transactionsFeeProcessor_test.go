...
import (
	...
	"github.com/DharitriOne/drt-chain-go/outport/mock"
...
func TestPutFeeAndGasUsedTx1(t *testing.T) {
	...
	initialTx := &outportcore.TxInfo{
		Transaction: &transaction.Transaction{
			Nonce:    1196667,
			SndAddr:  []byte("moa1k7j6ewjsla4zsgv8v6f6fe3dvrkgv3d0d9jerczw45hzedhyed8s6j67fv"),
			RcvAddr:  []byte("moa14eyayfrvlrhzfrwg5zwleua25mkzgncggn35nvc6xhv5yxwml2esz3hztm"),
			GasLimit: 16610000,
			GasPrice: 1000000000,
	...
	scr1 := &smartContractResult.SmartContractResult{
		...
		GasPrice:       1000000000,
		GasLimit:       14732500,
		SndAddr:        []byte("moa14eyayfrvlrhzfrwg5zwleua25mkzgncggn35nvc6xhv5yxwml2esz3hztm"),
		RcvAddr:        []byte("moa1qqqqqqqqqqqqqpgq3dswlnnlkfd3gqrcv3dhzgnvh8ryf27g5rfs5q4ukq"),
		...
		SmartContractResults: map[string]*outportcore.SCRInfo{
			...
			hex.EncodeToString(scrWithRefund): {
				SmartContractResult: &smartContractResult.SmartContractResult{
					Nonce:          3,
					SndAddr:        []byte("moa1qqqqqqqqqqqqqpgq3dswlnnlkfd3gqrcv3dhzgnvh8ryf27g5rfs5q4ukq"),
					RcvAddr:        []byte("moa1k7j6ewjsla4zsgv8v6f6fe3dvrkgv3d0d9jerczw45hzedhyed8s6j67fv"),
...
func TestPutFeeAndGasUsedLogWithErrorAndInformative(t *testing.T) {
	...
	tx1 := &outportcore.TxInfo{
		Transaction: &transaction.Transaction{
			GasLimit: 30000000,
			GasPrice: 1000000000,
			SndAddr:  []byte("moa1dglncxk6sl9a3xumj78n6z2xux4ghp5c92cstv5zsn56tjgtdwpsmdu0lq"),
			RcvAddr:  receiver,
			Data:     []byte("here"),
		},
		FeeInfo: &outportcore.FeeInfo{Fee: big.NewInt(0)},
...
func TestPutFeeAndGasUsedWrongRelayedTx(t *testing.T) {
	...
	initialTx := &outportcore.TxInfo{
		Transaction: &transaction.Transaction{
			Nonce:    1011,
			SndAddr:  []byte("moa1dglncxk6sl9a3xumj78n6z2xux4ghp5c92cstv5zsn56tjgtdwpsmdu0lq"),
			RcvAddr:  []byte("moa1xlrw5j482m3fwl72fsu9saj984rxqdrjd860e02tcz0qakvqrp6q8e505c"),
			GasLimit: 550000000,
			GasPrice: 1000000000,
	...
	scr1 := &outportcore.SCRInfo{
		SmartContractResult: &smartContractResult.SmartContractResult{
			Nonce:          1011,
			SndAddr:        []byte("moa1xlrw5j482m3fwl72fsu9saj984rxqdrjd860e02tcz0qakvqrp6q8e505c"),
			RcvAddr:        []byte("moa1dglncxk6sl9a3xumj78n6z2xux4ghp5c92cstv5zsn56tjgtdwpsmdu0lq"),
			PrevTxHash:     txHash,
			OriginalTxHash: txHash,
...
func TestPutFeeAndGasUsedDCDTWithScCall(t *testing.T) {
	...
	tx := &outportcore.TxInfo{
		Transaction: &transaction.Transaction{
			Nonce:    1011,
			SndAddr:  silentDecodeAddress("moa1dglncxk6sl9a3xumj78n6z2xux4ghp5c92cstv5zsn56tjgtdwpsmdu0lq"),
			RcvAddr:  silentDecodeAddress("moa1dglncxk6sl9a3xumj78n6z2xux4ghp5c92cstv5zsn56tjgtdwpsmdu0lq"),
			GasLimit: 55_000_000,
			GasPrice: 1000000000,
...
func TestPutFeeAndGasUsedScrWithRefund(t *testing.T) {
	...
	initialTx := &outportcore.TxInfo{Transaction: &transaction.Transaction{
		...
		GasLimit: 60_000_000,
		GasPrice: 1000000000,
		SndAddr:  []byte("moa1s8jr8e8hsvv7c9ehmshcjlpzf9ua5l50qeswa8feshrp6xlz9c7q3975hk"),
	}, FeeInfo: &outportcore.FeeInfo{Fee: big.NewInt(0)}}
	...
	scr := &outportcore.SCRInfo{
		SmartContractResult: &smartContractResult.SmartContractResult{
			Nonce:          1005,
			SndAddr:        []byte("moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqzllls29jpxv"),
			RcvAddr:        []byte("moa1s8jr8e8hsvv7c9ehmshcjlpzf9ua5l50qeswa8feshrp6xlz9c7q3975hk"),
			PrevTxHash:     txHash,
			OriginalTxHash: txHash,
			Value:          refundValueBig,
			Data:           []byte("@6f6b"),
...
func TestMoveBalanceWithSignalError(t *testing.T) {
	...
	initialTx := &outportcore.TxInfo{Transaction: &transaction.Transaction{
		...
		GasPrice: 1000000000,
		SndAddr:  []byte("moa1s8jr8e8hsvv7c9ehmshcjlpzf9ua5l50qeswa8feshrp6xlz9c7q3975hk"),
		RcvAddr:  []byte("moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqzllls29jpxv"),
