...
func TestInterceptedTxWithoutDataField(t *testing.T) {
	...
	testInterceptedTxFromFrontendGeneratedParams(
		...
		0,
		value,
		"moa12dnfhej64s6c56ka369gkyj3hwv5ms0y5rxgsk2k7hkd2vuk7rvqtwmsvd",
		"moa1l20m7kzfht5rhdnd4zvqr82egk7m4nvv3zk06yw82zqmrt9kf0zsyallus",
...
func TestInterceptedTxWithDataField(t *testing.T) {
	...
	testInterceptedTxFromFrontendGeneratedParams(
		...
		value,
		"moa12dnfhej64s6c56ka369gkyj3hwv5ms0y5rxgsk2k7hkd2vuk7rvqtwmsvd",
		"moa1vjdll4xqtyll7nx3xx83audv27k5ktppvcc8kddn2yhxhwrjadgqj5ddm7",
...
func TestInterceptedTxWithSigningOverTxHash(t *testing.T) {
	...
	testInterceptedTxFromFrontendGeneratedParams(
		...
		1,
		value,
		"moa1ez0puv8mqsulwllnavfygfzqe5zveeqjwpr6dsm8egchkf449kjqyl6zq2",
		"moa1ez0puv8mqsulwllnavfygfzqe5zveeqjwpr6dsm8egchkf449kjqyl6zq2",
