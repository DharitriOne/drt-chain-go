...
func TestDCDTScCallAndGasChangeShouldWork(t *testing.T) {
	...
	utils.CreateAccountWithDCDTBalance(t, testContext.Accounts, sndAddr, senderBalance, token, 0, localDcdtBalance)
...
func TestScCallDistributeStakingRewards_ShouldWork(t *testing.T) {
	...
	sndAddr1, err := pkConv.Decode("moa1rkhyj0ne054upekymjafwas44v2trdykd22vcg27ap8x2hpg5u7qzjr40f")
	require.Nil(t, err)
