...
func TestMultiDCDTNFTTransferViaRelayedV2(t *testing.T) {
	...
	utils.CreateAccountWithDCDTBalance(t, sh0Context.Accounts, sh0Addr, big.NewInt(100000000), tokenID1, 1, big.NewInt(1))
	utils.CreateAccountWithDCDTBalance(t, sh0Context.Accounts, sh0Addr, big.NewInt(100000000), tokenID2, 1, big.NewInt(1))
