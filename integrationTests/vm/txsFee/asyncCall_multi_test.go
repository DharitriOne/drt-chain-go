...
func deployForwarderAndTestContract(
	...
	utils.CreateAccountWithDCDTBalance(t, testContext.Accounts, forwarderSCAddress, rewaBalance, dcdtToken, 0, dcdtBalance)
...
func transferDCDTAndExecuteCrossShard(t *testing.T, numberOfCallsFromParent int, numberOfBackTransfers int) {
	...
	utils.CreateAccountWithDCDTBalance(t, forwarderShard.Accounts, forwarderSCAddress, rewaBalance, dcdtToken, 0, dcdtBalance)
