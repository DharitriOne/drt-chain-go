...
func TestAsyncDCDTCallShouldWork(t *testing.T) {
	...
	utils.CreateAccountWithDCDTBalance(t, testContext.Accounts, sndAddr, localRewaBalance, token, 0, localDcdtBalance)
...
func TestAsyncMultiTransferOnCallback(t *testing.T) {
	...
	utils.CreateAccountWithDCDTBalance(t, testContext.Accounts, ownerAddr, big.NewInt(1000000000), sftTokenID, sftNonce, sftBalance)
