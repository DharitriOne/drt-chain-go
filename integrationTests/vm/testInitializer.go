...
import (
	...
	"github.com/DharitriOne/drt-chain-core-go/data/scheduled"
	dataTransaction "github.com/DharitriOne/drt-chain-core-go/data/transaction"
	dataTx "github.com/DharitriOne/drt-chain-core-go/data/transaction"
	...
	"github.com/DharitriOne/drt-chain-go/epochStart/bootstrap/disabled"
	processDisabled "github.com/DharitriOne/drt-chain-go/genesis/process/disabled"
	...
	"github.com/DharitriOne/drt-chain-go/process/factory/metachain"
	"github.com/DharitriOne/drt-chain-go/process/factory/shard"
	"github.com/DharitriOne/drt-chain-go/process/guardian"
	...
	syncDisabled "github.com/DharitriOne/drt-chain-go/process/sync/disabled"
	"github.com/DharitriOne/drt-chain-go/process/transaction"
	"github.com/DharitriOne/drt-chain-go/process/transactionEvaluator"
	...
	commonMocks "github.com/DharitriOne/drt-chain-go/testscommon/common"
	dataRetrieverMock "github.com/DharitriOne/drt-chain-go/testscommon/dataRetriever"
	"github.com/DharitriOne/drt-chain-go/testscommon/dblookupext"
	...
	"github.com/DharitriOne/drt-chain-go/testscommon/integrationtests"
	...
	"github.com/DharitriOne/drt-chain-go/testscommon/txDataBuilder"
	...
	vmcommonBuiltInFunctions "github.com/DharitriOne/drt-chain-vm-common-go/builtInFunctions"
...
const DNSV2Address = "moa1qqqqqqqqqqqqqpgqcy67yanvwpepqmerkq6m8pgav0tlvgwxjmdqc06e67"

// DNSV2DeployerAddress defines the address of the deployer for the DNS v2 contracts
const DNSV2DeployerAddress = "moa1uzk2g5rhvg8prk9y50d0q7qsxg7tm7f320q0q4qlpmfu395wjmdqdufues"

// TestAddressPubkeyConverter represents an address public key converter
var TestAddressPubkeyConverter, _ = pubkeyConverter.NewBech32PubkeyConverter(32, "moa")
...
func createEconomicsData(enableEpochsConfig config.EnableEpochs) (process.EconomicsDataHandler, error) {
	...
	testProtocolSustainabilityAddress := "moa1932eft30w753xyvme8d49qejgkjc09n5e49w4mwdjtm0neld797s3hts63"
