...
import (
	...
	"github.com/DharitriOne/drt-chain-go/statusHandler"
...
func TestStatusMetrics_StatusMetricsWithoutP2PPrometheusStringShouldComputeRoundsAndNoncesPassedInEpoch(t *testing.T) {
	...
	assert.Contains(t, strRes, `moa_rounds_passed_in_current_epoch{moa_shard_id="2"} 37`)
	assert.Contains(t, strRes, `moa_nonces_passed_in_current_epoch{moa_shard_id="2"} 38`)
}
...
func TestStatusMetrics_NetworkConfig(t *testing.T) {
	...
	expectedConfig := map[string]interface{}{
		"moa_chain_id":                      "local-id",
		"moa_denomination":                  uint64(18),
		"moa_gas_per_data_byte":             uint64(1500),
		"moa_latest_tag_software_version":   "version1.0",
		"moa_meta_consensus_group_size":     uint64(25),
		"moa_min_gas_limit":                 uint64(50000),
		"moa_extra_gas_limit_guarded_tx":    uint64(50000),
		"moa_min_gas_price":                 uint64(1000),
		"moa_min_transaction_version":       uint64(2),
		"moa_num_metachain_nodes":           uint64(50),
		"moa_num_nodes_in_shard":            uint64(100),
		"moa_num_shards_without_meta":       uint64(1),
		"moa_rewards_top_up_gradient_point": "12345",
		"moa_round_duration":                uint64(5000),
		"moa_shard_consensus_group_size":    uint64(20),
		"moa_start_time":                    uint64(9999),
		"moa_top_up_factor":                 "12.134",
		"moa_gas_price_modifier":            "0.5",
		"moa_rounds_per_epoch":              uint64(144),
		"moa_max_gas_per_transaction":       uint64(15000),
		"moa_adaptivity":                    "true",
		"moa_hysteresis":                    "0.000000",
	}
...
func TestStatusMetrics_NetworkMetrics(t *testing.T) {
	...
	expectedConfig := map[string]interface{}{
		"moa_current_round":                  uint64(200),
		"moa_round_at_epoch_start":           uint64(100),
		"moa_nonce":                          uint64(180),
		"moa_block_timestamp":                uint64(18000),
		"moa_highest_final_nonce":            uint64(181),
		"moa_nonce_at_epoch_start":           uint64(95),
		"moa_epoch_number":                   uint64(1),
		"moa_rounds_per_epoch":               uint64(50),
		"moa_rounds_passed_in_current_epoch": uint64(100),
		"moa_nonces_passed_in_current_epoch": uint64(85),
	}
...
func TestStatusMetrics_EnableEpochMetrics(t *testing.T) {
	...
	sm.SetUInt64Value(common.MetricDcdtEnableEpoch, 4)
