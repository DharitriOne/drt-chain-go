//go:generate protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/DharitriOne/protobuf/protobuf  --gogoslick_out=. miniblockMetadata.proto
...
import (
	...
	"github.com/DharitriOne/drt-chain-core-go/core/container"
	...
	"github.com/DharitriOne/drt-chain-go/common/logging"
