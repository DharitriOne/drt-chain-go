...
type SupplyDCDT struct {
	Supply           *math_big.Int `protobuf:"bytes,1,opt,name=Supply,proto3,casttypewith=math/big.Int;github.com/DharitriOne/drt-chain-core-go/data.BigIntCaster" json:"value"`
	Burned           *math_big.Int `protobuf:"bytes,2,opt,name=Burned,proto3,casttypewith=math/big.Int;github.com/DharitriOne/drt-chain-core-go/data.BigIntCaster" json:"burned"`
	Minted           *math_big.Int `protobuf:"bytes,3,opt,name=Minted,proto3,casttypewith=math/big.Int;github.com/DharitriOne/drt-chain-core-go/data.BigIntCaster" json:"minted"`
